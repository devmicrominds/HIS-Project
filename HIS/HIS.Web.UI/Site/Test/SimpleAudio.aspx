<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SimpleAudio.aspx.cs" Inherits="HIS.Web.UI.Site.Test.SimpleAudio" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="<%= Page.ResolveUrl("~/Contents/musicPlayer04/audio.min.js") %>"></script>
    <title></title>
    <style>
        body {
            color: #666;
