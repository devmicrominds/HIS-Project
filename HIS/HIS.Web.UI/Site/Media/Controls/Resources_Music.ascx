<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="Resources_Music.ascx.cs" Inherits="HIS.Web.UI.Site.Media.Controls.Resources_Music" %>

<div id="resource_music_view">
    <div id="resources_music_category_menu" class="mailbox-content tab-right">
    ...
    <div class="tab-content">
        <div id="tab_view" class="tab-pane fade in active">
            ...
            <asp:GridView ID="__grid" ItemType="HIS.Data.MediaCategory" CssClass="gridview table-striped table-hover" AutoGenerateColumns="false"
                ...
                <PagerTemplate>
                    <sym:Pager ID="Pager1" runat="server" PagerContext="resources.musiccategory" />
                </PagerTemplate>
                <EmptyDataTemplate>
        ...
        <div id="tab_add" class="tab-pane fade">
            <div class="body">
                <div id="Div4" class="form-horizontal">
                    <fieldset>
                        <legend style="padding-left: 10px;">Add New Music Category</legend>                        
...
<script type="text/javascript">
    ...
    var ResourceMusicView = Backbone.View.extend(
    {
        initialize: function (options) {
            var self = this;
            self.options = options;
            self._$menu = this.$el.find('#resources_music_category_menu');
            self.color = '#3289c7';
            $.validate();
            $('#picker').colpick({
                flat: true,
        ...
        _validatedata: function () {
            if (!$('#name').val()) {
                alert('Please Enter Music Category Name');
                return false;
            }
            if (!$('#description').val()) {
                alert('Please Enter Music Category Description');
                return false;
            }
            return true;
        },
    ...
    $(function () {
        var resMusic = new ResourceMusicView({ el: '#resource_music_view' });
        resMusic.render();
    });
