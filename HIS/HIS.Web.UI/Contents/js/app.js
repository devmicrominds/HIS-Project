...
Backbone.REQUEST.ADD_TICKER = 'ADD_TICKER';
Backbone.REQUEST.ADDEDIT_HTML = 'ADDEDIT_HTML';
...
amplify.request.define(Backbone.REQUEST.ADDEDIT_HTML, 'ajax', {
    url: '/app/Media/HtmlAdd',
    type: 'POST', dataType: 'json', contentType: 'application/json;charset=utf-8', decoder: 'AppDecoder'
});

amplify.request.define(Backbone.REQUEST.ADD_TICKER, 'ajax', {
    url: '/app/Media/SaveTicker',
    type: 'POST', dataType: 'json', contentType: 'application/json;charset=utf-8', decoder: 'AppDecoder'
});
